 ...
 * @since 2018-09-08
 */
@ApiModel(value = "会员对象", description = "members")
...
public class Members implements Serializable {
	 ...
	 * 会员账号
	 */
	@ApiModelProperty(value = "会员账号", name = "account", example = "test1", required = true)
	...
	public String toString() {
		return "Members{" + ", id=" + id + ", account=" + account + ", password=" + password + ", type=" + type
				+ ", username=" + username + ", phone=" + phone + ", address=" + address + ", email=" + email
				+ ", intentionalStyle=" + intentionalStyle + ", cardNo=" + cardNo + "}";
	}
}
